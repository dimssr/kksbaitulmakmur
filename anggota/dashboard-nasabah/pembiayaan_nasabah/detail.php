        			...
        			<tr>
        				...
        				<th><?php echo $data['id_pembiayaan']; ?></th>                                        
                                ...
                                <tr>
                                        ...
                                        <th><?php echo 'Rp. '.number_format($data['jumlah_pembiayaan']) ?></th>                                        
                                </tr>
                                <tr>
                                        <th>Jangka Waktu</th>                                        
                                 ...
                                 <tr>
                                        ...
                                        <th><?php echo 'Rp. '.number_format($data['bayar_perbulan']) ?></th>                                        
                                </tr>
                                <tr>
                                        <th>Total Bayar</th>                                        
                                        <th><?php echo 'Rp. '.number_format($data['total_bayar']) ?></th>                                        
                                </tr>
                                <tr>
                                        <th>Sisa</th>                                        
                                        ...
                                        <?php } else { ?>
                                        <th><?php echo 'Rp. '.number_format($sisa); ?> <small> <a href="?page=pembiayaan_nasabah&action=detail_transaksi&id_pembiayaan=<?php echo $data['id_pembiayaan'];?>">Detail Transaksi</a></small></th>  
                                        <?php } ?>                                         
                                </tr>
                                <tr>
                                ...
                                <tr>
                                        <th>Status</th>         
                                        <th><?php echo $data['status_pembayaran'] ?></th>                               
                                </tr>
        		</thead>        		
        	</table>
		</div><!-- col-lg-12-->      	
