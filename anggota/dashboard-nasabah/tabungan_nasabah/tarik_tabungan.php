...
$sql2=mysqli_query($con,"select * from total_tabungan_nasabah WHERE rek_tabungan = '$rek_tabungan'") or die (mysqli_error($con));
            ...
            <form class="form-horizontal style-form" method="post">
              <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        <input type="number" name="nominal" max="<?php echo $total ?>" class="form-control">
                    </div>
                </div>
...
mysqli_query($con, "INSERT INTO tabungan_nasabah (id_tabungan, rek_tabungan, id_nasabah, id_produk, nominal_tarik, status, tgl_setor) values (null,'$rek_tabungan','$id_nasabah','$id_produk','$nominal','Tarik','$tgl')") or die (mysqli_error($con));
