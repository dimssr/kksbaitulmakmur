...
$sql2=mysqli_query($con,"select * from total_tabungan_anggota WHERE rek_tabungan = '$rek_tabungan'") or die (mysqli_error($con));
...
mysqli_query($con, "INSERT INTO tabungan_anggota (id_tabungan, rek_tabungan, id_anggota, id_produk, nominal_tarik, status, tgl_setor) values (null,'$rek_tabungan','$id_anggota','$id_produk','$nominal','Tarik','$tgl')") or die (mysqli_error($con));
