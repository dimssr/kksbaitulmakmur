				...
				<div class="carousel-inner" role="listbox">
					...
					<div class="item active" style="background-image: url(frontend/img/header.jpg);">
						<div class="carousel-caption">
							...
							<p data-wow-duration="1000ms" class="wow bounceInDown animated">Koperasi Konsumen Syari'ah - KKS</p>
							
								<h2 data-wow-duration="700ms" data-wow-delay="500ms" class="wow bounceInDown animated">Baitul Makmur Barokah<span> Jawa Timur</span></h2>
							</div>
