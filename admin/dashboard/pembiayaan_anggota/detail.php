        	...
        	<table class="table table-striped">
        		<thead>
                    ...
                    <tr>
                            ...
                            <th><?php echo $data['nama_produk']; ?></th>                                        
                    </tr>
                    <tr>
                    ...
                    <tr>
                            ...
                            <?php } else { ?>
                            <th><?php echo 'Rp. '.number_format($sisa, 3); ?> <small> <a href="?page=pembiayaan_anggota&action=detail_transaksi&id_pembiayaan=<?php echo $data['id_pembiayaan'];?>">Detail Transaksi</a></small></th>  
                            <?php } ?>                                         
                    </tr>
                    <tr>
