...
<div class="row mt">
	<div class="col-lg-12">
      ...
      <?php } ?>
      <a href="?page=simpanan_anggota&action=cek_bayar" title="Cek" class="btn btn-success" style="margin-left: 5px">Cek yang Belum Bayar</a>
