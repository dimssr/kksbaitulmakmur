<h3><i class="fa fa-angle-right"></i> Nama Produk Kopsyah</h3>
<div class="row mt">
	<div class="col-lg-12">
              ...
              <section id="unseen">
                <table class="table table-bordered table-striped" id="Datatables">
                  ...
                  <tr>
                      ...
                      <td>
    <?php
    $text = $data['desk_produk'];
    if (strlen($text) > 100) {
        $cutPosition = strpos($text, ' ', 100);
        if ($cutPosition === false) {
            // Jika tidak ada spasi setelah 100 karakter, potong hingga 100 karakter
            echo substr($text, 0, 100) . '...';
        } else {
            // Jika ada spasi, potong hingga posisi spasi
            echo substr($text, 0, $cutPosition) . '...';
        }
    } else {
        // Jika teks kurang dari atau sama dengan 100 karakter, tampilkan seluruhnya
        echo $text;
    }
    ?>
                      </td>
